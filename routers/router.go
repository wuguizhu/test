...
func init() {
	...
	speedtestURL := beego.AppConfig.String("post_speedtest_url")
	resultsURL := beego.AppConfig.String("get_results_url")
	speedtestResultsURL := beego.AppConfig.String("get_speedtest_results_url")
	...
	beego.Router(speedtestURL, &controllers.SpeedtestIPsController{}, "post:HandleSpeedtestIPs")
	beego.Router(resultsURL, &controllers.ResultsController{}, "get:GetResults")
	beego.Router(speedtestResultsURL, &controllers.SpeedtestResultsController{}, "get:GetResults")
